...
var removed = {
  CYPRESS_BINARY_VERSION: {
    description: stripIndent(_templateObject7, chalk.green('3.0.0')),
    solution: stripIndent(_templateObject8)
  },
...
function getPlatformInfo() {
  return util.getOsVersionAsync().then(function (version) {
    return stripIndent(_templateObject11, os.platform(), version, util.pkgVersion());
  });
}
...
function formErrorText(info, msg) {
  ...
  return addPlatformInformation(info).then(function (obj) {
    ...
    function add(msg) {
      formatted.push(stripIndents(_templateObject12, msg));
    }
